    ...
    <div class="relative z-10 w-full max-w-md px-6 py-10 flex flex-col items-center animate-fade-in">
        ...
        <div class="relative rounded-lg px-6 py-4 bg-maroon-light/20 mb-8 w-full flex justify-center">
            <div class="absolute inset-0 flex items-center justify-center opacity-80">
                <i id="gear-icon" class="fas fa-gears text-white text-7xl animate-fade-in animate-spin-slow"></i>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="w-full space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-red-primary"><i class="fas fa-user"></i></span>
            ...
            <div>
                ...
                <div class="relative">
                    <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-red-primary"><i class="fas fa-envelope"></i></span>
            ...
            <div>
                ...
                <div class="relative">
                    <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-red-primary"><i class="fas fa-lock"></i></span>
        ...
        <div class="mt-6 text-center text-white text-sm">
            <a href="{{ route('login') }}" class="underline hover:text-red-200 transition">Already have an account?</a>
        </div>
    </div>
</body>
</html>