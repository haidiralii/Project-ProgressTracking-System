    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-8 animate-fade-in">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Add a new project to the system</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2 flex flex-col mb-4">
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="rounded-md border border-gray-300 px-4 py-3 text-base focus:ring-2 focus:ring-red-500 focus:border-transparent bg-white transition-all duration-200 resize-y" placeholder="Describe the project...">{{ old('description') }}</textarea>
                    </div>
                    <div class="flex flex-col mb-4">
